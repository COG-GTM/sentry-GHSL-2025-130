...
class SlackOptionsLoadEndpoint(Endpoint):
    ...
    def post(self, request: Request) -> Response:
        ...
        # The group id comes from the untrusted Slack payload, so it may point at an issue
        # belonging to an organization that is not connected to the requesting integration.
